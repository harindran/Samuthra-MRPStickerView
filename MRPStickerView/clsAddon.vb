...
Namespace MRPStickerView
    Public Class clsAddon
        ...
        Public HWKEY() As String = New String() {"V0913316776", "R1574408489", "L1653539483"}
...
#Region "Menu Creation Details"
        ...
        Private Sub Menu()
            ...
            'CreateMenu("", Menucount, "Sub-Contracting", SAPbouiCOM.BoMenuType.mt_POPUP, "SUBPO", "42545")
            Menucount = 1 'Menu Inside  
            CreateMenu("", Menucount, "MRP", SAPbouiCOM.BoMenuType.mt_STRING, "MRP", "4352") : Menucount += 1
        ...
        Public Sub MenuEvent_For_FormOpening(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean)
            Try
                If pVal.BeforeAction = False Then
                    Select Case pVal.MenuUID
                        Case "MRP"
                            If Not FormExist("MRP") Then
                                Dim activeform As New FrmMRPSticker
                                activeform.Show()
                            End If
                    End Select
