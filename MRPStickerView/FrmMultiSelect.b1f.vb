...
Namespace MRPStickerView
    <FormAttribute("MULPROD", "FrmMultiSelect.b1f")>
    Friend Class FrmMultiSelect
        ...
        Public Overrides Sub OnInitializeComponent()
            ...
            Me.Grid0 = CType(Me.GetItem("Item_2").Specific, SAPbouiCOM.Grid)
        ...
        Private Sub OnCustomInitialize()
            Try
                objform = objaddon.objapplication.Forms.GetForm("MULPROD", 0)
                'LoadGrid("SELECT 'N' ""Select"",T0.""Code"", T0.""Name"" FROM ""@PRODGRP"" T0")
        ...
        Private Sub LoadGrid(ByVal query As String)
            Try
                ...
                Grid0.Columns.Item("Name").Editable = False
        ...
        Private Sub Button0_ClickAfter(sboObject As System.Object, pVal As SAPbouiCOM.SBOItemEventArg) Handles Button0.ClickAfter
            Try
                ...
                If code <> "" Then
                    FrmMultiSel.Items.Item("txtPCode").Specific.string = ""
                    FrmMultiSel.Items.Item("txtPCode").Specific.string = code
                End If
                FrmMultiSel = Nothing
                objform.Close()
            Catch ex As Exception
