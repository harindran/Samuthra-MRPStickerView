Namespace MRPStickerView
    ...
    Public Class clsTable
        ...
        Public Sub FieldCreation()
            AddTables("MIPL_MRP", "MRP", SAPbobsCOM.BoUTBTableType.bott_Document)
            AddFields("@MIPL_MRP", "FromDate", "From Date", SAPbobsCOM.BoFieldTypes.db_Date)
            AddFields("@MIPL_MRP", "ToDate", "To Date", SAPbobsCOM.BoFieldTypes.db_Date)
            AddFields("@MIPL_MRP", "Whse", "Whse Code", SAPbobsCOM.BoFieldTypes.db_Alpha, 50)
            AddFields("@MIPL_MRP", "SerStart", "Serial Starts", SAPbobsCOM.BoFieldTypes.db_Alpha, 50)
            AddFields("@MIPL_MRP", "SerEnd", "Serial Ends", SAPbobsCOM.BoFieldTypes.db_Alpha, 50)

            AddTables("MRP_DATA", "MRP Form Details", SAPbobsCOM.BoUTBTableType.bott_NoObject)
            AddFields("@MRP_DATA", "RName", "Report Name", SAPbobsCOM.BoFieldTypes.db_Alpha, 50)
            AddFields("@MRP_DATA", "FDate", "From Date", SAPbobsCOM.BoFieldTypes.db_Alpha, 20)
            AddFields("@MRP_DATA", "TDate", "To Date", SAPbobsCOM.BoFieldTypes.db_Alpha, 20)
            AddFields("@MRP_DATA", "Whse", "Warehouse", SAPbobsCOM.BoFieldTypes.db_Alpha, 20)
            AddFields("@MRP_DATA", "SStart", "Serial Starts", SAPbobsCOM.BoFieldTypes.db_Alpha, 20)
            AddFields("@MRP_DATA", "SEnd", "Serial Ends", SAPbobsCOM.BoFieldTypes.db_Alpha, 20)
            AddFields("@MRP_DATA", "BtnProd", "ProductCode Btn", SAPbobsCOM.BoFieldTypes.db_Alpha, 20)
            AddFields("@MRP_DATA", "ProdForm", "Product Form", SAPbobsCOM.BoFieldTypes.db_Alpha, 20)
            AddFields("@MRP_DATA", "ProdMat", "Product matrix", SAPbobsCOM.BoFieldTypes.db_Alpha, 20)
            AddFields("@MRP_DATA", "ProdVal", "Product ColValue", SAPbobsCOM.BoFieldTypes.db_Alpha, 20)
            AddFields("@MRP_DATA", "ChkProdVal", "Product Col ChkValue", SAPbobsCOM.BoFieldTypes.db_Alpha, 20)
            AddFields("@MRP_DATA", "ProdOK", "Product OK", SAPbobsCOM.BoFieldTypes.db_Alpha, 20)
        End Sub
